  ...
  public: {
    Tables: {
      ...
      judge_feedback: {
        ...
        Relationships: [
          {
            foreignKeyName: "judge_feedback_from_judge_id_fkey"
            columns: ["from_judge_id"]
            isOneToOne: false
            referencedRelation: "judges"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "judge_feedback_hackathon_id_fkey"
            columns: ["hackathon_id"]
            isOneToOne: false
            referencedRelation: "hackathons"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "judge_feedback_team_id_fkey"
            columns: ["team_id"]
            isOneToOne: false
            referencedRelation: "teams"
            referencedColumns: ["id"]
